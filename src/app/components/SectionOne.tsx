    ...
    <div className="flex justify-center items-center flex-col h-screen relative bg-bg-2 text-black">
      <div className="flex flex-col justify-center w-[1200px] h-full">
        <div className="w-full text-center">
          ...
          <div className="bg-white p-4 rounded-xl mt-6 shadow-xl">
            <p className="">
        ...
        <div className="mt-16 w-full">
          ...
          <div className="flex flex-row gap-[40px] w-full mt-8">
            <div className="bg-white p-8 rounded-xl w-1/3 flex flex-col justify-start shadow-primary">
            ...
            <div className="bg-white p-8 rounded-xl w-1/3 flex flex-col justify-start shadow-secondary">
              <h3 className="text-lg font-semibold flex items-center">
              ...
              <p className="text-silver text-xs mt-2">
                ...
                ответов. Эти советы помогут вам лучше понять себя и разработать
                стратегии для улучшения качества жизни.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl w-1/3 flex flex-col justify-start shadow-third">
              <h3 className="text-lg font-semibold flex items-center">
